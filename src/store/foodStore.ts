...
export const useFoodStore = create<FoodStore>()(
  persist(
    (set) => ({
      ...
      spinResults: [],
      users: [
        { id: 'u1', fullName: 'Nguyễn Văn A', role: 'STUDENT', schoolId: 's1', classId: 'c1', isApproved: true, parentId: 'u2' },
        { id: 'u3', fullName: 'Lê Minh C', role: 'STUDENT', schoolId: 's1', classId: 'c1', isApproved: true },
        { id: 'u4', fullName: 'Phạm Gia Hân', role: 'STUDENT', schoolId: 's1', classId: 'c1', isApproved: true },
        { id: 'u5', fullName: 'Đỗ Bảo Nam', role: 'STUDENT', schoolId: 's1', classId: 'c2', isApproved: true },
        { id: 'u6', fullName: 'Hoàng Mỹ An', role: 'STUDENT', schoolId: 's1', classId: 'c2', isApproved: false },
        { id: 'u2', fullName: 'Trần Thị B', role: 'PARENT', schoolId: 's1', classId: 'c1', isApproved: true, studentId: 'u1' },
        { id: 'u7', fullName: 'Ngô Văn Hòa', role: 'PARENT', schoolId: 's1', classId: 'c2', isApproved: true, studentId: 'u5' },
        { id: 'u8', fullName: 'Đào Thị Lan', role: 'PARENT', schoolId: 's1', classId: 'c2', isApproved: false, studentId: 'u6' },
      ],
      schools: [
        { 
          id: 's1', 
